            ...
            <div className='p-6'>
                ...
                <div>
                    ...
                    <div className="flex items-center mb-4">
                        <input disabled type="radio" value="" name="default-radio" className="w-4 text-gray-500 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <a onClick={handleAdd} className='ml-2 text-sm cursor-pointer text-gray-500'>Add option</a>
                    </div>
                </div>
            </div>
            <FieldAction formFields={props.formFields} handleDelete={props.handleDelete} index={props.index} field={props.field} fieldType="Multiple Choice" />
        </div>
    )
}
