    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-[20px]">
                <Link href="/campaigns/0" className="flex h-48 items-center justify-center p-6 bg-white border border-gray-200 rounded-sm dark:bg-gray-800 dark:border-gray-700 block p-6 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                {campaigns?.map((item: ICampaign, index: number) => (
                    <Link key={index} href={`/campaigns/${item.id}`} className="p-6 bg-white border border-gray-200 rounded-sm dark:bg-gray-800 dark:border-gray-700 block p-6 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
